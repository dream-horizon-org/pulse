"""Time-bucketed Apdex, error, and user-category trends for Block 5 diagnosis."""
...
from pulse_ai.agents.em.templates.interaction_templates import build_interaction_metric_trends_query
...
async def fetch_interaction_metric_trends(
    ...
    """Load hourly (auto-bucketed) trends: Apdex, errors, user experience mix.

    Matches Interaction Details graphs — use for Block 5 reliability/latency trend lens.
    ...
    try:
        query_request = build_interaction_metric_trends_query(
