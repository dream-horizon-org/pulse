...
export function Layout({ children }: LayoutProps) {
  ...
  // Show header on all authenticated pages except login, initial onboarding, and Slack OAuth callback
  ...
  const isSlackCallbackPage = pathname === ROUTES.SLACK_CALLBACK.basePath;
  const shouldShowHeader =
    !isLoginPage && !isInitialOnboarding && !isSlackCallbackPage;
