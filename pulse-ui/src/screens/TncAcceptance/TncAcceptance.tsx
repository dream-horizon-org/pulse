      ...
      <Box className={classes.container}>
        <Box className={classes.card}>
          <Stack align="center" gap="md" className={classes.successContainer}>
            ...
            <Text className={classes.successText}>Terms Accepted</Text>
            <Text className={classes.successSubtext}>
              Redirecting to your workspace...
            </Text>
            <LoaderWithMessage loadingMessage="Setting up your workspace..." />
          </Stack>
        </Box>
        ...
        <Stack gap="xl">
          ...
          <div className={classes.documentList}>
            ...
            {tncStatus.documents?.aup && (
              ...
              >
                <div
                  className={`${classes.documentIcon} ${classes.documentIconAup}`}
                >
                  <IconShieldCheck size={18} />
                </div>
                <div className={classes.documentMeta}>
            ...
            {tncStatus.documents?.privacy_policy && (
              ...
              >
                <div
                  className={`${classes.documentIcon} ${classes.documentIconPp}`}
                >
                  <IconLock size={18} />
                </div>
                <div className={classes.documentMeta}>
          ...
          <Checkbox
            ...
            label={
              <Text className={classes.consentText}>
                ...
                <span className={classes.consentHighlight}>
                  Terms of Service
                </span>
                ,{" "}
                <span className={classes.consentHighlight}>
