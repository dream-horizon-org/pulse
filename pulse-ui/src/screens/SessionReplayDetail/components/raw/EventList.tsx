import { ActionIcon, Badge, Box, Stack, Text, Tooltip } from "@mantine/core";
        ...
        <Stack gap={0}>
          {unifiedEvents.map((event, idx) => {
            ...
            const isInRange = scrollToTimestamp
              ...
              : false;
            const isActive = isHighlighted || isPlaybackHighlight || isInRange;
            ...
            const rawContent = lastColon >= 0 ? full.slice(0, lastColon) : full;
            ...
            return (
              ...
              >
                <Box className={classes.eventRow}>
                  <Text size="xs" c="dimmed" className={classes.eventTime}>
                    {formatAbsoluteTime(sessionData.startTime, event.timestamp)}
                  </Text>
