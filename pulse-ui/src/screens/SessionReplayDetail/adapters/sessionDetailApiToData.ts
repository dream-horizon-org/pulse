...
/**
 * Truncate fractional seconds past milliseconds so `Date.parse` is reliable.
 * React Native / OTEL payloads may use nanoseconds (e.g. .212328583Z); ES Date often returns NaN.
 */
...
/**
 * Parse event or network timestamp (absolute ISO string, unix ms, or relative ms) to
