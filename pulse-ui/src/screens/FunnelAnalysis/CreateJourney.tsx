...
import { IconArrowLeft, IconRoute, IconSquareRoundedX } from "@tabler/icons-react";
              ...
              <Stack className={createFormClasses.filtersCreateStep} gap="xl">
                <Box>
                  ...
                  <Text className={createFormClasses.filtersCreateHint} mt="xs">
                    ...
                    limit which users are included when this journey is computed.
                  </Text>
                </Box>
                <GlobalFilterBar
                  comfortable
                ...
                <Box className={createFormClasses.finalStepCard}>
                  ...
                  <Text size="sm" c="dimmed" lh={1.55}>
                    Filters above apply to how this journey is computed. After
                    creation, open the journey detail page to explore the Sankey
