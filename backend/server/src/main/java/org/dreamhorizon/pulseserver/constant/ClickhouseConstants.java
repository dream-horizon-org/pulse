...
public class ClickhouseConstants {
  ...
  public final String CH_APDEX_SELECT_CLAUSE = "avgIf(toFloat64OrNull(SpanAttributes['uptimeIndex']), StatusCode != 'ERROR')";
  ...
  public final String EXCELLENT_CAT = "countIf(ifNull(SpanAttributes['userCategory'], '') = 'EXCELLENT')";
  public final String GOOD_CAT = "countIf(ifNull(SpanAttributes['userCategory'], '') = 'GOOD')";
  public final String AVERAGE_CAT = "countIf(ifNull(SpanAttributes['userCategory'], '') = 'AVERAGE')";
  public final String POOR_CAT = "countIf(ifNull(SpanAttributes['userCategory'], '') = 'POOR')";
