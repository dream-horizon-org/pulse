...
/**
 * Implementation of {@link SparkJobService}.
 */
@Slf4j
@Singleton
public final class SparkJobServiceImpl implements SparkJobService {
   ...
   * Constructor.
   *
   * @param client the EMR client
   */
  @Inject
  public SparkJobServiceImpl(final EmrServerlessJobClient client) {
    this.emrClient = client;
  }

  @Override
  public Single<SparkJobResponse> submitJob(final SparkJobRequest request) {
  ...
  @Override
  public Single<GetJobRunResponse> getJobStatus(final String jobRunId) {
    return Single.fromCallable(() -> {
