...
public class CreateJourneyRequest {
  ...
  @NotNull @Builder.Default private JourneyDirection direction = JourneyDirection.START;

  @NotNull @Min(1) @Builder.Default private Integer depth = 5;

  @NotNull @Builder.Default private FunnelMode mode = FunnelMode.UNIQUE_USERS;

  @Valid private List<FunnelAttributeFilter> filters;

  @NotNull @Builder.Default private FunnelType journeyType = FunnelType.AUTO;
