...
public enum Functions {
  ...
  APP_VITALS_CRASH_FREE_USERS_PERCENTAGE("crashFreeUsersPercentage", ClickhouseConstants.CRASH_FREE_USERS_PERCENTAGE),
  APP_VITALS_CRASH_FREE_SESSIONS_PERCENTAGE("crashFreeSessionsPercentage", ClickhouseConstants.CRASH_FREE_SESSIONS_PERCENTAGE),
  APP_VITALS_CRASH_USERS("crashUsers", ClickhouseConstants.CRASH_USERS),
  APP_VITALS_CRASH_SESSIONS("crashSessions", ClickhouseConstants.CRASH_SESSIONS),
  APP_VITALS_ALL_USERS("allUsers", ClickhouseConstants.ALL_USERS),
  APP_VITALS_ALL_SESSIONS("allSessions", ClickhouseConstants.ALL_SESSIONS),
  APP_VITALS_ANR_FREE_USERS_PERCENTAGE("anrFreeUsersPercentage", ClickhouseConstants.ANR_FREE_USERS_PERCENTAGE),
  APP_VITALS_ANR_FREE_SESSIONS_PERCENTAGE("anrFreeSessionsPercentage", ClickhouseConstants.ANR_FREE_SESSIONS_PERCENTAGE),
  APP_VITALS_ANR_USERS("anrUsers", ClickhouseConstants.ANR_USERS),
  APP_VITALS_ANR_SESSIONS("anrSessions", ClickhouseConstants.ANR_SESSIONS),
  APP_VITALS_NON_FATAL_FREE_USERS_PERCENTAGE("nonFatalFreeUsersPercentage", ClickhouseConstants.NON_FATAL_FREE_USERS_PERCENTAGE),
  APP_VITALS_NON_FATAL_FREE_SESSIONS_PERCENTAGE("nonFatalFreeSessionsPercentage", ClickhouseConstants.NON_FATAL_FREE_SESSIONS_PERCENTAGE),
  APP_VITALS_NON_FATAL_USERS("nonFatalUsers", ClickhouseConstants.NON_FATAL_USERS),
  APP_VITALS_NON_FATAL_SESSIONS("nonFatalSessions", ClickhouseConstants.NON_FATAL_SESSIONS),
