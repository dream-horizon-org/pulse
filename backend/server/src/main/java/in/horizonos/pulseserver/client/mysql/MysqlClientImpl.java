...
import static in.horizonos.pulseserver.constant.Constants.MYSQL_DATABASE;
import static in.horizonos.pulseserver.constant.Constants.MYSQL_PASSWORD;
import static in.horizonos.pulseserver.constant.Constants.MYSQL_READER_HOST;
import static in.horizonos.pulseserver.constant.Constants.MYSQL_READER_MAX_POOL_SIZE;
import static in.horizonos.pulseserver.constant.Constants.MYSQL_USER;
import static in.horizonos.pulseserver.constant.Constants.MYSQL_WRITER_HOST;
import static in.horizonos.pulseserver.constant.Constants.MYSQL_WRITER_MAX_POOL_SIZE;
