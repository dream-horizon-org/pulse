      ...
      vertx.runOnContext(v -> {
        ...
        result.whenComplete((resp, err) -> {
          testContext.verify(() -> {
            ...
            assertEquals("http://default-config.example.com/test/config/interaction.json",
      ...
      return PulseConfig.builder()
          ...
          .sampling(PulseConfig.SamplingConfig.builder()
              ...
              .rules(Arrays.asList(
                  ...
                  PulseConfig.SamplingRule.builder()
                      ...
                      .sdks(Arrays.asList(Sdk.pulse_ios_swift))
                      .value("2.0.0")
              ...
              .criticalSessionPolicies(PulseConfig.CriticalSessionPolicies.builder()
                  .alwaysSend(Arrays.asList(
                      PulseConfig.CriticalPolicyRule.builder()
                          ...
                          .sdks(Arrays.asList(Sdk.pulse_ios_rn))
                          .build()
                  ))
                  .build())
              .build())
          .signals(PulseConfig.SignalsConfig.builder()
              ...
              .attributesToAdd(Arrays.asList(
                  PulseConfig.AttributeToAdd.builder()
                      .values(Arrays.asList(
                          PulseConfig.AttributeValue.builder()
                              .name("environment")
                              .value("production")
                              .build(),
                          PulseConfig.AttributeValue.builder()
          ...
          .features(Arrays.asList(
              ...
              PulseConfig.FeatureConfig.builder()
                  ...
                  .sdks(Arrays.asList(Sdk.pulse_android_rn))
                  .build()
          ))
          .build();
    }
