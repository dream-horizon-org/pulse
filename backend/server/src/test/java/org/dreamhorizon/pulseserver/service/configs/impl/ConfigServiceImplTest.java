...
class ConfigServiceImplTest {
  ...
  class TestGetConfigByVersion {
    ...
    void shouldGetConfigByVersionSuccessfully() {
      ...
      when(sdkConfigsDao.getConfig(ProjectContext.getProjectId(), version)).thenReturn(Single.just(expectedConfig));

      // When
      PulseConfig result = configService.getSdkConfig(ProjectContext.getProjectId(), version).blockingGet();
      ...
      verify(sdkConfigsDao, times(1)).getConfig(ProjectContext.getProjectId(), version);
    ...
    void shouldPropagateErrorWhenDaoFails() {
      ...
      when(sdkConfigsDao.getConfig(ProjectContext.getProjectId(), version)).thenReturn(Single.error(daoError));

      // When
      var testObserver = configService.getSdkConfig(ProjectContext.getProjectId(), version).test();
  ...
  class TestGetActiveConfig {
    ...
    void shouldGetActiveConfigSuccessfully() {
      ...
      when(sdkConfigsDao.getConfig(ProjectContext.getProjectId())).thenReturn(Single.just(expectedConfig));

      // When
      PulseConfig result = configService.getActiveSdkConfig(ProjectContext.getProjectId()).blockingGet();
      ...
      verify(sdkConfigsDao, times(1)).getConfig(ProjectContext.getProjectId());
    }
    ...
    void shouldReturnCachedConfigOnSubsequentCalls() {
      ...
      // When - first call
      PulseConfig result1 = configService.getActiveSdkConfig(ProjectContext.getProjectId()).blockingGet();
      // Second call - should use cache
      PulseConfig result2 = configService.getActiveSdkConfig(ProjectContext.getProjectId()).blockingGet();
    ...
    void shouldPropagateErrorWhenCacheLoadFails() {
      ...
      when(sdkConfigsDao.getConfig(ProjectContext.getProjectId())).thenReturn(Single.error(daoError));

      // When
      var testObserver = configService.getActiveSdkConfig(ProjectContext.getProjectId()).test();
  ...
  class TestCreateConfig {
    ...
    void shouldInvalidateCacheAfterCreatingConfig() {
      ...
      configService.getActiveSdkConfig(ProjectContext.getProjectId()).blockingGet();
      ...
      verify(sdkConfigsDao, times(2)).getConfig(ProjectContext.getProjectId());
    }
