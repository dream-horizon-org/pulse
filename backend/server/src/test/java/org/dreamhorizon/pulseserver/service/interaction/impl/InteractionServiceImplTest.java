...
class InteractionServiceImplTest {
    ...
    class TestCreateInteraction {
        ...
        final String user = "himanshu.pandey@dream11.com";
        ...
        void shouldThrowExceptionIfInteractionAlreadyPresent() {
            ...
            Mockito.when(interactionDao.isInteractionPresent(interactionName)).thenReturn(Single.just(true));

            TestObserver<InteractionDetails> expectedValue = interactionService.createInteraction(request).test();
        ...
        void shouldThrowExceptionIfInteractionPresentCheckFailed() {
            ...
            Mockito.when(interactionDao.isInteractionPresent(interactionName)).thenReturn(Single.error(new RuntimeException("Database error")));
        ...
        void shouldThrowExceptionIfCreateInteractionFailed() {
            ...
            Mockito.when(interactionDao.isInteractionPresent(interactionName)).thenReturn(Single.just(false));
        ...
        void shouldNotThrowErrorIfUploadInteractionDetailsFails() {
            ...
            ArgumentCaptor<InteractionDetails> interactionDetailsArgumentCaptor = ArgumentCaptor.forClass(InteractionDetails.class);
            CreateInteractionDaoResponse expectedDaoResponse = Mockito.mock(CreateInteractionDaoResponse.class);
            ...
            Mockito.when(interactionDao.isInteractionPresent(interactionName)).thenReturn(Single.just(false));
            Mockito.when(interactionDao.createInteractionAndUploadMetadata(interactionDetailsArgumentCaptor.capture()))
            ...
            assertEquals(interactionDetailsArgumentCaptor.getValue().getThresholdInMs(), interactionThreshold);
            assertEquals(interactionDetailsArgumentCaptor.getValue().getUptimeLowerLimitInMs(), uptimeLowerLimit);
            assertEquals(interactionDetailsArgumentCaptor.getValue().getUptimeMidLimitInMs(), uptimeMidLimit);
            assertEquals(interactionDetailsArgumentCaptor.getValue().getUptimeUpperLimitInMs(), uptimeUpperLimit);
            assertEquals(InteractionStatus.RUNNING, interactionDetailsArgumentCaptor.getValue().getStatus());
            ...
            assertEquals(0, interactionDetailsArgumentCaptor.getValue().getGlobalBlacklistedEvents().size());
            ...
            actual.assertValue(interaction -> {
                try {
                    assertThat(interaction).usingRecursiveComparison().isEqualTo(expectedInteraction);
                    return true;
                } catch (Exception e) {
                    return false;
                }
    ...
    class TestGetInteraction {
        ...
        void shouldThrowExceptionIfGetInteractionFromDaoFailed() {
            ...
            TestObserver<InteractionDetails> actual = interactionService.getInteractionDetails(interactionName).test();
    ...
    class TestDeleteInteraction {
        ...
        void shouldThrowExceptionIfDeleteInteractionFromDaoFailed() {
            ...
            ArgumentCaptor<DeleteInteractionRequest> requestCaptor = ArgumentCaptor.forClass(DeleteInteractionRequest.class);
            ...
            actual.assertError(RuntimeException.class);
            Mockito.verify(interactionDao, Mockito.times(1)).deleteInteractionAndCreateUploadMetadata(any());
        ...
        void shouldNotThrowExceptionIfUploadInteractionFailed() {
            DeleteInteractionRequest request = buildDeleteRequest();
            ArgumentCaptor<DeleteInteractionRequest> deleteRequestCaptor = ArgumentCaptor.forClass(DeleteInteractionRequest.class);
            InteractionDetailUploadMetadata expectedUploadMetadata = InteractionDetailUploadMetadata
                    ...
                    .build();
            Mockito.when(interactionDao.deleteInteractionAndCreateUploadMetadata(deleteRequestCaptor.capture()))
    ...
    class TestUpdateInteraction {
        ...
        void shouldUpdateInteractionWhenAllFieldsAreProvided() {
            ...
            ArgumentCaptor<InteractionDetails> interactionDetailsCaptor = ArgumentCaptor.forClass(InteractionDetails.class);

            Mockito.when(interactionDao.getInteractionDetails(interactionName))
                    .thenReturn(Single.just(existingInteraction));
            Mockito.when(interactionDao.updateInteractionAndCreateUploadMetadata(interactionDetailsCaptor.capture()))
            ...
            actual.assertNoErrors();
            Mockito.verify(interactionDao, Mockito.times(1)).getInteractionDetails(interactionName);
            Mockito.verify(interactionDao, Mockito.times(1)).updateInteractionAndCreateUploadMetadata(any());
            ...
            assertThat(capturedInteraction.getGlobalBlacklistedEvents().get(0).getName()).isEqualTo("event2");
        ...
        void shouldNotUpdateInteractionWhenNoFieldsAreProvided() {
            ...
            assertThat(capturedInteraction.getEvents().get(0).getName()).isEqualTo("event1");
            assertThat(capturedInteraction.getGlobalBlacklistedEvents()).hasSize(1);
            assertThat(capturedInteraction.getGlobalBlacklistedEvents().get(0).getName()).isEqualTo("event3");
            assertThat(capturedInteraction.getUpdatedBy()).isEqualTo(user);
            assertThat(capturedInteraction.getCreatedBy()).isEqualTo("user1");
        ...
        void shouldUpdateInteractionWhenOnlyFewFieldsAreProvided() {
            ...
            assertThat(capturedInteraction.getEvents().get(1).getProps().get(0).getName()).isEqualTo("propName");
            assertThat(capturedInteraction.getEvents().get(1).getProps().get(0).getValue()).isEqualTo("propValue");
            assertThat(capturedInteraction.getGlobalBlacklistedEvents()).hasSize(1);
            assertThat(capturedInteraction.getGlobalBlacklistedEvents().get(0).getName()).isEqualTo("event3");
            assertThat(capturedInteraction.getUpdatedBy()).isEqualTo(user);
            assertThat(capturedInteraction.getCreatedBy()).isEqualTo("user1");
    ...
    class TestGetInteractions {
        ...
        void shouldReturnInteractionsWhenDaoReturnsValidResponse() {
            ...
            TestObserver<GetInteractionsResponse> actual = interactionService.getInteractions(request).test();
    ...
    class TestGetAllActiveAndRunningInteractions {
        ...
        void shouldThrowExceptionWhenDaoFailsToGetActiveAndRunningInteractions() {
            ...
            TestObserver<List<InteractionDetails>> actual = interactionService.getAllActiveAndRunningInteractions().test();
        ...
        void shouldSuccessfullyGetAllActiveAndRunningInteractions() {
            ...
            actual.assertNoErrors()
                    .assertValue(interactions -> {
                        try {
                            assertThat(interactions).usingRecursiveComparison().isEqualTo(expectedInteractions);
                            return true;
                        } catch (Exception e) {
                            return false;
                        }
    ...
    class TestGetInteractionFilterOptions {
        ...
        void shouldReturnFilterOptionsSuccessfully() {
            ...
            List<String> createdByUsers = List.of("user1@example.com", "user2@example.com", "user3@example.com");
            ...
            TestObserver<InteractionFilterOptionsResponse> actual = interactionService.getInteractionFilterOptions().test();
    ...
    class TestGetTelemetryFilterOptions {
        ...
        void shouldReturnTelemetryFilterOptionsSuccessfully() {
            ...
            TestObserver<TelemetryFilterOptionsResponse> actual = interactionService.getTelemetryFilterOptions().test();
        ...
        void shouldHandleErrorWhenDaoFails() {
            ...
            actual.assertError(RuntimeException.class)
                    .assertError(throwable -> throwable.getMessage().equals("ClickHouse query failed"));
