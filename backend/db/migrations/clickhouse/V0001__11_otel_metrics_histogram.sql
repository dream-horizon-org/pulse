...
--changeset db-migrations:V0001__11_otel_metrics_histogram runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline: otel.otel_metrics_histogram MergeTree table and project_monthly_metrics_histogram_mv materialized view.
