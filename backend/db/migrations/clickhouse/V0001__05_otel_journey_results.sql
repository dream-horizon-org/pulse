...
--changeset db-migrations:V0001__05_otel_journey_results runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline: otel.journey_results MergeTree table for Spark journey job output.
