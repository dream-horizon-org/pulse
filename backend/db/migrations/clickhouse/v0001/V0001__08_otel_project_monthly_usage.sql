...
--changeset db-migrations:V0001__08_otel_project_monthly_usage runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline: otel.project_monthly_usage AggregatingMergeTree table plus 3 materialized views for logs, traces, and stack trace events.
