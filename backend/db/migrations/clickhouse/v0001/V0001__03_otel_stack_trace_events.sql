...
--changeset db-migrations:V0001__03_otel_stack_trace_events runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline: otel.stack_trace_events MergeTree table for crash and error stack traces.
