...
--changeset db-migrations:V0001__13_otel_metrics_summary runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline: otel.otel_metrics_summary MergeTree table, otel.otel_metrics unified VIEW, and project_monthly_metrics_summary_mv materialized view.
