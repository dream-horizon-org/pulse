...
--changeset db-migrations:V0001__04_otel_funnel_results runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline: otel.funnel_results MergeTree table for Spark funnel job output.
