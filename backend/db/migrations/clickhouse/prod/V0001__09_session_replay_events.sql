...
--changeset db-migrations:V0001__09_session_replay_events runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline (prod): V0001__09_session_replay_events.sql
