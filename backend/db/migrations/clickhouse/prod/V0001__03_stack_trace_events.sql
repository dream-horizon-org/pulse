...
--changeset db-migrations:V0001__03_stack_trace_events runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline (prod): V0001__03_stack_trace_events.sql
