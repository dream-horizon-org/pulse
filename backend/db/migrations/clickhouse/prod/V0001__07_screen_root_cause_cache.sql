...
--comment Baseline (prod): V0001__07_screen_root_cause_cache.sql

CREATE TABLE otel.screen_root_cause_cache_local
ON CLUSTER 'pulse-ch'
(
...
ON CLUSTER 'pulse-ch'
AS otel.screen_root_cause_cache_local
    ENGINE = Distributed('pulse-ch', otel, screen_root_cause_cache_local, cityHash64((ProjectId, screen_name)));
