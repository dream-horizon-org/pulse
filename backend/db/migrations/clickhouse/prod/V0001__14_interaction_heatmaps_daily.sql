...
--changeset db-migrations:V0001__14_interaction_heatmaps_daily runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline (prod): V0001__14_interaction_heatmaps_daily.sql
