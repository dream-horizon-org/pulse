...
--changeset db-migrations:V0001__06_root_cause_cache runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline (prod): V0001__06_root_cause_cache.sql
