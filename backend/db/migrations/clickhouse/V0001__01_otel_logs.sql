...
--changeset db-migrations:V0001__01_otel_logs runOnChange:false failOnError:true splitStatements:true endDelimiter:; dbms:clickhouse
--comment Baseline: otel.otel_logs MergeTree table with MATERIALIZED columns and bloom filter indexes.
