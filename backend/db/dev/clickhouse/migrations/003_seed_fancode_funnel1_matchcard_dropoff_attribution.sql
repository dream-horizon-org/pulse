-- Dummy drop-off attribution for MatchCardToMatchDetail (MySQL id=1, project fancode).
...
ALTER TABLE otel.funnel_dropoff_attribution
    DELETE WHERE ProjectId = 'fancode' AND FunnelId = 1
...
VALUES
    (1, 'fancode', '2026-05-25 12:00:00.000', 0, 'MatchCardClicked', 41434, 100.0, NULL),
    (1, 'fancode', '2026-05-25 12:00:00.000', 1, 'MatchPageLoaded', 40935, 98.8, 12),
    (1, 'fancode', '2026-05-25 12:00:00.000', 2, 'ClickedBuyPass', 13, 0.03, 180),
    (1, 'fancode', '2026-05-25 12:00:00.000', 3, 'OrderInitiated', 2, 0.005, 45),
    (1, 'fancode', '2026-05-25 12:00:00.000', 4, 'OrderSuccessful', 1, 0.002, 30);
...
VALUES
(
    1, 'fancode', '2026-05-25 12:00:00.000', 2,
    'http_5xx', 'POST api.fancode.com/v2/match/buy-pass 503', '503 @ buy-pass API',
    40922, 12276, 13, 0,
    999.0, 0.0001,
...
(
    1, 'fancode', '2026-05-25 12:00:00.000', 2,
    'http_4xx', 'GET api.fancode.com/v2/entitlement/match 403', '403 @ match entitlement',
    40922, 8184, 13, 1,
    630.0, 0.0001,
...
VALUES
(
    1, 'fancode', '2026-05-25 12:00:00.000', 1,
    'http_5xx', 'GET api.fancode.com/v2/match/card 502', '502 @ match card API',
    499, 75, 40935, 409,
    7.4, 0.001,
    ['mc-sess-card-502-a']
),
