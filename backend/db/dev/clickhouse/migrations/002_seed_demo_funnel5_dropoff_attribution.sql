...
-- Funnel: MySQL id=5 (SectionContentClickedToPLAY), project demo-streaming, focus step 0 → StepIndex 1.
...
ALTER TABLE otel.funnel_dropoff_attribution
    DELETE WHERE ProjectId = 'demo-streaming' AND FunnelId = 5
...
VALUES
    (5, 'demo-streaming', '2026-05-25 12:00:00.000', 0, 'SectionContentClicked', 10000, 100.0, NULL),
    (5, 'demo-streaming', '2026-05-25 12:00:00.000', 1, 'PLAY', 6200, 62.0, 45);
...
VALUES
(
    5, 'demo-streaming', '2026-05-25 12:00:00.000', 1,
    'http_5xx', 'POST api.demo-streaming.example.com/v1/play 503', '503 @ play API',
    3800, 456, 6200, 62,
    2.41, 0.001,
...
(
    5, 'demo-streaming', '2026-05-25 12:00:00.000', 1,
    'http_4xx', 'GET api.demo-streaming.example.com/v1/entitlement 403', '403 @ entitlement check',
    3800, 152, 6200, 31,
    2.01, 0.005,
...
VALUES
(
    5, 'demo-streaming', '2026-05-25 12:00:00.000', 2,
