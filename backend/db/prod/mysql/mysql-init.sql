...
CREATE TABLE IF NOT EXISTS funnel (
    ...
    revenue_attribute  VARCHAR(128) NULL                         COMMENT 'Optional event-attribute key carrying numeric order value',
    revenue_step_index INT          NULL                         COMMENT 'Optional 0-based step index of the order/purchase event',
    currency           VARCHAR(8)   NULL                         COMMENT 'Display-only ISO-4217 currency code',
