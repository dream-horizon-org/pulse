...
-- ============================================================================
-- default-project demo interaction seeds are intentionally omitted here.
-- They are loaded only for local/deploy MySQL (see deploy/db/mysql-init.sql and
-- backend/db/dev/mysql/mysql-init.sql via backend/db/shared/mysql-default-project-interactions.sql).
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS funnel (
    ...
    analysis_basis    VARCHAR(16)  NOT NULL DEFAULT 'EVENT'    COMMENT 'Funnel: all steps. Journey: path after anchor (anchor always event).',
