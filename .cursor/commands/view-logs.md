...
1. Ask which service to view logs for if not specified. Available Docker services: pulse-server, pulse-ui, pulse-alerts-cron, otel-collector, mysql, clickhouse, openfga (vector optional: enable via VECTOR_ENABLED=true)
