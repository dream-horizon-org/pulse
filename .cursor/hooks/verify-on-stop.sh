...
sot_files=("deploy/docker-compose.yml" "backend/ingestion/clickhouse-otel-schema.sql" "backend/ingestion/clickhouse-heatmap-schema.sql" "backend/ingestion/session-summary-mv.sql" "deploy/.env.example" "deploy/scripts/build.sh" "deploy/scripts/start.sh")
sot_changed=false
