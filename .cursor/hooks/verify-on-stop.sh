...
sot_files=("deploy/docker-compose.yml" "backend/ingestion/clickhouse-otel-schema.sql" "deploy/.env.example" "deploy/scripts/build.sh" "deploy/scripts/start.sh" "deploy/scripts/common.sh")
sot_changed=false
