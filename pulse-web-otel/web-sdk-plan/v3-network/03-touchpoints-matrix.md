...
| Area | File | Change |
|------|------|--------|
| Semconv | [`src/semconv.ts`](../../src/semconv.ts) | HTTP stable attribute keys; `pulse.type` values from [`networkPulseType`](../../src/utils/network-http.ts); `error.type`, GraphQL keys. |
| Config | [`src/types/config.ts`](../../src/types/config.ts) | `InstrumentationConfig.network` subtree (`peerServiceMap`, `blockedUrls`, headers, `captureQueryParams`, …). |
...
| Helpers | [`src/utils/network-http.ts`](../../src/utils/network-http.ts) | Sanitize URL, ignore list, `applyPulseHttpClientSpanAttributes`. |
...
| E2E | [`examples/ecommerce-demo/e2e/m4-network.spec.ts`](../../examples/ecommerce-demo/e2e/m4-network.spec.ts) | Positive `http` span + gate-off zero spans. |
