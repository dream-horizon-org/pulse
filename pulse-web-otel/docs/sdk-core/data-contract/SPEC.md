...
| `web_vital` | `src/__tests__/web-vitals-instrumentation.test.ts` | `@WebVitals` · `web-vitals.spec.ts`; nextjs-demo `e2e/web-vitals.spec.ts` | In gate (ecommerce); Next optional local run |
