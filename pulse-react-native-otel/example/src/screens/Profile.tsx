...
export default function ProfileScreen({ route, navigation }: NativeStackScreenProps<RootStackParamList, 'Profile'>) {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Button title="Go to Details" onPress={() => navigation.navigate('Details', { itemId: 99 })} />
        </View>
  
        <View style={styles.buttonContainer}>
          <Button title="Go to Settings" onPress={() => navigation.navigate('Settings')} color="#ff9800" />
        </View>
