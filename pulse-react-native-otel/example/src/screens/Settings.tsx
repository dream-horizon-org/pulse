    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Button title="Go to Profile" onPress={() => navigation.navigate('Profile', { userId: 'settings-user' })} />
        </View>
  
        <View style={styles.buttonContainer}>
          <Button title="Back" onPress={() => navigation.goBack()} color="#f44336" />
        </View>
  
        <Text style={styles.info}>
          🔙 Back navigation is also tracked!
        </Text>
      </View>
    );
  }
