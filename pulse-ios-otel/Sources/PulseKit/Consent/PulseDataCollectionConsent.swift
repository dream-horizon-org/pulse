...
public enum PulseDataCollectionConsent {
    /// Telemetry is buffered in memory; nothing is exported. Buffer limit: 5000 per signal (spans, logs; metrics: up to 5000 MetricData values). Newest dropped when full.
    case pending
