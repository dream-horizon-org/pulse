...
// (for example, 400 process * 400 maps * 128 bytes = 20 MB + string data).
    ...
    public:
        ...
        inline void set_start(uint64_t value) {
            start_ = value;
        }
        ...
        inline void set_end(uint64_t value) {
            end_ = value;
        }
        ...
        inline void set_offset(uint64_t value) {
            offset_ = value;
        }
        ...
        inline SharedString &name() {
            return name_;
        }

        inline void set_name(SharedString &value) {
            name_ = value;
        }
        ...
        inline ElfFields *elf_fields() {
            return elf_fields_.load();
        }

        inline std::shared_ptr<Elf> &elf() {
            return GetElfFields().elf_;
        }

        inline void set_elf(std::shared_ptr<Elf> &value) {
            GetElfFields().elf_ = value;
        }

        inline void set_elf(Elf *value) {
            GetElfFields().elf_.reset(value);
        }

        inline uint64_t elf_offset() {
            return GetElfFields().elf_offset_;
        }

        inline void set_elf_offset(uint64_t value) {
            GetElfFields().elf_offset_ = value;
        }

        inline uint64_t elf_start_offset() {
            return GetElfFields().elf_start_offset_;
        }

        inline void set_elf_start_offset(uint64_t value) {
            GetElfFields().elf_start_offset_ = value;
        }

        inline std::atomic_int64_t &load_bias() {
            return GetElfFields().load_bias_;
        }

        inline void set_load_bias(int64_t value) {
            GetElfFields().load_bias_ = value;
        }

        inline std::atomic<SharedString *> &build_id() {
            return GetElfFields().build_id_;
        }

        inline void set_build_id(SharedString *value) {
            GetElfFields().build_id_ = value;
        }

        inline bool memory_backed_elf() {
            return GetElfFields().memory_backed_elf_;
        }

        inline void set_memory_backed_elf(bool value) {
            GetElfFields().memory_backed_elf_ = value;
        }

        inline MapInfo *prev_map() const {
            return prev_map_;
        }

        inline void set_prev_map(MapInfo *value) {
            prev_map_ = value;
        }

        inline MapInfo *prev_real_map() const {
            return prev_real_map_;
        }

        inline void set_prev_real_map(MapInfo *value) {
            prev_real_map_ = value;
        }

        inline MapInfo *next_real_map() const {
            return next_real_map_;
        }

        inline void set_next_real_map(MapInfo *value) {
            next_real_map_ = value;
        }
        ...
        inline bool IsBlank() {
            return offset() == 0 && flags() == 0 && name().empty();
        }
