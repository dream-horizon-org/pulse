...
// Forward declarations.
    ...
    public:
        ...
        void set_dex_pc(uint64_t dex_pc) {
            dex_pc_ = dex_pc;
        }
        ...
        virtual bool SetPseudoRegister(uint16_t, uint64_t) {
            return false;
        }

        virtual bool GetPseudoRegister(uint16_t, uint64_t *) {
            return false;
        }
    ...
    public:
        ...
        inline AddressType &operator[](size_t reg) {
            return regs_[reg];
        }
