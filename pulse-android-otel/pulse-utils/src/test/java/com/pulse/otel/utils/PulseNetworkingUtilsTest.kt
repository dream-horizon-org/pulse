...
class PulseNetworkingUtilsTest {
    ...
    fun `extract base url`(
        ...
        val result = PulseNetworkingUtils.extractBaseUrlWithSlash(inputUrl)
        assertThat(result).describedAs("Failed for: $description").isEqualTo(expectedOutput)
    }
