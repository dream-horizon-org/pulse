...
load_env() {
    ...
    export CONFIG_SERVICE_APPLICATION_SPARK_JOB_JAR_PATH="${CONFIG_SERVICE_APPLICATION_SPARK_JOB_JAR_PATH:-local:///usr/lib/spark/examples/jars/spark-examples.jar}"
    export CONFIG_SERVICE_APPLICATION_SPARK_JOB_FUNNELS_MAIN_CLASS="${CONFIG_SERVICE_APPLICATION_SPARK_JOB_FUNNELS_MAIN_CLASS:-org.dreamhorizon.spark.FunnelsDailyBatch}"
    export CONFIG_SERVICE_APPLICATION_SPARK_JOB_JOURNEYS_MAIN_CLASS="${CONFIG_SERVICE_APPLICATION_SPARK_JOB_JOURNEYS_MAIN_CLASS:-org.dreamhorizon.spark.JourneysDailyBatch}"
    export CONFIG_SERVICE_APPLICATION_SPARK_JOB_EVENTS_MAIN_CLASS="${CONFIG_SERVICE_APPLICATION_SPARK_JOB_EVENTS_MAIN_CLASS:-org.dreamhorizon.spark.EventsIncrementalBatch}"
