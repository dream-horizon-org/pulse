...
# -------------------------------------------------------------------
SECRET_NAME="prod/pulses3archiver/appenv"
ENV_FILE=".pulse-s3-archiver.env"
...
echo "Exported $(wc -l < $ENV_FILE) environment variables to $HOME/.pulse-s3-archiver.env"
...
CODEARTIFACT_REPOSITORY="pulse-s3-archiver"
APPLICATION_NAME="pulse-s3-archiver"
...
# 6. Start Application
# -------------------------------------------------------------------
echo "Starting pulse-s3-archiver"
set -a
source "$ENV_FILE"
set +a
...
nohup java \
    ...
    run org.dreamhorizon.pulses3archiver.verticle.MainVerticle \
