...
('USAGE_LIMIT_THRESHOLD', 'EMAIL', 1, JSON_OBJECT(
    ...
    'html', '<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><style>body{font-family:Arial,sans-serif;line-height:1.6;color:#333;margin:0;padding:0}.container{max-width:600px;margin:0 auto;padding:20px}.header{background-color:#ff9800;color:white;padding:20px;text-align:center;border-radius:5px 5px 0 0}.content{background-color:#f9f9f9;padding:20px;border:1px solid #ddd;border-radius:0 0 5px 5px}.metric-box{background-color:white;padding:15px;margin:10px 0;border-left:4px solid #ff9800;border-radius:3px}.metric-label{font-weight:bold;color:#666;font-size:14px}.metric-value{font-size:24px;color:#ff9800;font-weight:bold;margin-top:5px}.footer{margin-top:20px;padding:15px;text-align:center;font-size:12px;color:#666}.cta-button{display:inline-block;padding:12px 24px;background-color:#ff9800;color:white;text-decoration:none;border-radius:5px;margin:20px 0;font-weight:bold}</style></head><body><div class=\"container\"><div class=\"header\"><h1 style=\"margin:0\">⚠️ Usage Alert</h1></div><div class=\"content\"><p>Your project <strong>{{projectName}}</strong> has reached <strong>{{threshold}}%</strong> of your monthly {{notifyFor}} limit.</p><h3>Current Usage:</h3><div class=\"metric-box\"><div class=\"metric-label\">Events Usage</div><div class=\"metric-value\">{{eventsPercentage}}%</div></div><div class=\"metric-box\"><div class=\"metric-label\">Sessions Usage</div><div class=\"metric-value\">{{sessionsPercentage}}%</div></div><p>Please review your usage to avoid service interruption.</p><div style=\"text-align:center\"><a href=\"{{dashboardUrl}}/projects/{{projectId}}/usage\" class=\"cta-button\">View Usage Details</a></div></div><div class=\"footer\"><p>This is an automated notification from Pulse Observability Platform</p></div></div></body></html>',
    'text', '[Pulse] Usage Alert: {{threshold}}% {{notifyFor}} limit reached\n\nYour project {{projectName}} has reached {{threshold}}% of your monthly {{notifyFor}} limit.\n\nCurrent Usage:\n- Events: {{eventsPercentage}}%\n- Sessions: {{sessionsPercentage}}%\n\nPlease review your usage to avoid service interruption.\n\nView details: {{dashboardUrl}}/projects/{{projectId}}/usage\n\n--\nThis is an automated notification from Pulse Observability Platform'
))
ON DUPLICATE KEY UPDATE body = body;
...
('USAGE_LIMIT_REACHED', 'EMAIL', 1, JSON_OBJECT(
    ...
    'html', '<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><style>body{font-family:Arial,sans-serif;line-height:1.6;color:#333;margin:0;padding:0}.container{max-width:600px;margin:0 auto;padding:20px}.header{background-color:#d32f2f;color:white;padding:20px;text-align:center;border-radius:5px 5px 0 0}.content{background-color:#fff3f3;padding:20px;border:2px solid #d32f2f;border-radius:0 0 5px 5px}.warning-box{background-color:#ffebee;border-left:4px solid #d32f2f;padding:15px;margin:20px 0;border-radius:3px}.metric-box{background-color:white;padding:15px;margin:10px 0;border-left:4px solid #666;border-radius:3px}.metric-box.at-limit{border-left-color:#d32f2f}.metric-label{font-weight:bold;color:#666;font-size:14px}.metric-value{font-size:24px;font-weight:bold;margin-top:5px}.metric-value.at-limit{color:#d32f2f}.buffer-info{background-color:#fff9c4;padding:12px;margin:15px 0;border-radius:5px;border-left:3px solid #ffa000}.cta-button{display:inline-block;padding:12px 24px;background-color:#d32f2f;color:white;text-decoration:none;border-radius:5px;margin:20px 0;font-weight:bold}.footer{margin-top:20px;padding:15px;text-align:center;font-size:12px;color:#666}</style></head><body><div class=\"container\"><div class=\"header\"><h1 style=\"margin:0\">🚨 Limit Reached</h1></div><div class=\"content\"><div class=\"warning-box\"><strong>⚠️ ACTION REQUIRED:</strong> Your project <strong>{{projectName}}</strong> has reached 100% of your monthly {{notifyFor}} limit.</div><p><strong>You are currently using your overage buffer.</strong> Please upgrade soon to avoid service interruption.</p><div class=\"buffer-info\"><strong>ℹ️ Overage Buffer Active:</strong> You have an overage buffer to prevent immediate service disruption. However, your service will be blocked if usage continues to increase.</div><h3>Current Usage:</h3><div class=\"metric-box at-limit\"><div class=\"metric-label\">Events Usage</div><div class=\"metric-value at-limit\">100%</div></div><div class=\"metric-box\"><div class=\"metric-label\">Sessions Usage</div><div class=\"metric-value\">{{sessionsPercentage}}%</div></div><p><strong>Immediate Actions:</strong></p><ul><li>Upgrade your plan to avoid service disruption</li><li>Review and optimize your instrumentation</li><li>Your service will be blocked if you exceed the overage buffer</li></ul><div style=\"text-align:center\"><a href=\"{{dashboardUrl}}/projects/{{projectId}}/billing\" class=\"cta-button\">Upgrade Plan Now</a></div></div><div class=\"footer\"><p>This is an automated notification from Pulse Observability Platform</p></div></div></body></html>',
    'text', '[URGENT] {{projectName}} has reached 100% {{notifyFor}} limit\n\n⚠️ ACTION REQUIRED\n\nYour project {{projectName}} has reached 100% of your monthly {{notifyFor}} limit.\n\nYou are currently using your overage buffer. Please upgrade soon to avoid service interruption.\n\nℹ️ Overage Buffer Active: You have an overage buffer to prevent immediate service disruption. However, your service will be blocked if usage continues to increase.\n\nCurrent Usage:\n- Events: 100% ⚠️ AT LIMIT\n- Sessions: {{sessionsPercentage}}%\n\nIMMEDIATE ACTIONS:\n- Upgrade your plan to avoid service disruption\n- Review and optimize your instrumentation\n- Your service will be blocked if you exceed the overage buffer\n\nUpgrade now: {{dashboardUrl}}/projects/{{projectId}}/billing\n\n--\nThis is an automated notification from Pulse Observability Platform'
))
ON DUPLICATE KEY UPDATE body = body;
...
('USAGE_LIMIT_BLOCKED', 'EMAIL', 1, JSON_OBJECT(
    ...
    'html', '<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><style>body{font-family:Arial,sans-serif;line-height:1.6;color:#333;margin:0;padding:0}.container{max-width:600px;margin:0 auto;padding:20px}.header{background-color:#b71c1c;color:white;padding:20px;text-align:center;border-radius:5px 5px 0 0}.content{background-color:#ffebee;padding:20px;border:3px solid #b71c1c;border-radius:0 0 5px 5px}.critical-box{background-color:#f44336;color:white;padding:20px;margin:20px 0;border-radius:5px;text-align:center}.metric-box{background-color:white;padding:15px;margin:10px 0;border-left:4px solid #666;border-radius:3px}.metric-box.blocked{border-left-color:#b71c1c;background-color:#ffcdd2}.metric-label{font-weight:bold;color:#666;font-size:14px}.metric-value{font-size:24px;font-weight:bold;margin-top:5px}.blocked-badge{display:inline-block;background-color:#b71c1c;color:white;padding:8px 16px;border-radius:5px;font-size:18px;font-weight:bold;margin-top:5px}.explanation-box{margin-top:20px;padding:15px;background-color:#fff;border-left:4px solid #b71c1c;border-radius:3px}.cta-button{display:inline-block;padding:15px 30px;background-color:#b71c1c;color:white;text-decoration:none;border-radius:5px;margin:20px 0;font-weight:bold;font-size:16px}.footer{margin-top:20px;padding:15px;text-align:center;font-size:12px;color:#666}</style></head><body><div class=\"container\"><div class=\"header\"><h1 style=\"margin:0\">🔴 CRITICAL: Service Blocked</h1></div><div class=\"content\"><div class=\"critical-box\"><h2 style=\"margin:0\">SERVICE BLOCKED</h2><p style=\"margin:10px 0 0 0;font-size:18px\">Your project <strong>{{projectName}}</strong> has exceeded its limit</p></div><p><strong style=\"color:#b71c1c\">Your {{notifyFor}} data ingestion has been BLOCKED.</strong> No new data is being accepted until you upgrade your plan.</p><h3>Current Status:</h3><div class=\"metric-box blocked\"><div class=\"metric-label\">Events Status</div><div><span class=\"blocked-badge\">🚫 BLOCKED</span></div></div><div class=\"metric-box\"><div class=\"metric-label\">Sessions Status</div><div class=\"metric-value\">{{sessionsPercentage}}%</div></div><p><strong style=\"color:#b71c1c\">CRITICAL - UPGRADE REQUIRED:</strong></p><ul><li><strong>Upgrade immediately</strong> to restore data ingestion</li><li>Your observability data is not being collected</li><li>Service will resume automatically after upgrade</li></ul><div style=\"text-align:center\"><a href=\"{{dashboardUrl}}/projects/{{projectId}}/billing\" class=\"cta-button\">UPGRADE NOW - RESTORE SERVICE</a></div><div class=\"explanation-box\"><strong>What happened?</strong> You exceeded your monthly limit and overage buffer. To protect your account, data ingestion has been stopped.</div></div><div class=\"footer\"><p>This is an automated critical notification from Pulse Observability Platform</p></div></div></body></html>',
