...
('usage_limit_threshold', 'EMAIL', 1, JSON_OBJECT(
    ...
    'html', '<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><style>body{font-family:Arial,sans-serif;line-height:1.6;color:#333;margin:0;padding:0}.container{max-width:600px;margin:0 auto;padding:20px}.header{background-color:#0ba09a;color:white;padding:20px;text-align:center;border-radius:5px 5px 0 0}.content{background-color:#f9f9f9;padding:20px;border:1px solid #ddd;border-radius:0 0 5px 5px}.metric-box{background-color:white;padding:15px;margin:10px 0;border-left:4px solid #ff9800;border-radius:3px}.metric-label{font-weight:bold;color:#666;font-size:14px}.metric-value{font-size:24px;color:#ff9800;font-weight:bold;margin-top:5px}.footer{margin-top:20px;padding:15px;text-align:center;font-size:12px;color:#666}.cta-button{display:inline-block;padding:12px 24px;background-color:#0ba09a;color:white;text-decoration:none;border-radius:5px;margin:20px 0;font-weight:bold}</style></head><body><div class=\"container\"><div class=\"header\"><h1 style=\"margin:0\">Usage Alert</h1></div><div class=\"content\"><p>Your project <strong>{{projectName}}</strong> has reached <strong>{{threshold}}%</strong> of your monthly {{notifyFor}} limit.</p><h3>Current Usage:</h3><div class=\"metric-box\"><div class=\"metric-label\">Events Usage</div><div class=\"metric-value\">{{eventsPercentageDisplay}}%</div></div><div class=\"metric-box\"><div class=\"metric-label\">Sessions Usage</div><div class=\"metric-value\">{{sessionsPercentageDisplay}}%</div></div><p>Please review your usage to avoid service interruption.</p><div style=\"text-align:center\"><a href=\"{{dashboardUrl}}/projects/{{projectId}}\" class=\"cta-button\">View Usage Details</a></div></div><div class=\"footer\"><p>This is an automated notification from Pulse Observability Platform</p></div></div></body></html>',
...
('usage_limit_blocked', 'EMAIL', 1, JSON_OBJECT(
    ...
    'html', '<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><style>body{font-family:-apple-system,BlinkMacSystemFont,sans-serif;line-height:1.6;color:#333;margin:0;padding:0}.container{max-width:600px;margin:0 auto;padding:24px}.header{background-color:#0ba09a;color:white;padding:24px;text-align:center;border-radius:8px 8px 0 0}.content{background-color:#fff;padding:24px;border:1px solid #c62828;border-top:none;border-radius:0 0 8px 8px}.critical-box{background-color:#c62828;color:white;padding:20px;margin:20px 0;border-radius:6px;text-align:center}.metric-box{background-color:#fafafa;padding:16px;margin:12px 0;border-left:4px solid #666;border-radius:4px}.metric-box.blocked{border-left-color:#c62828;background-color:#ffebee}.metric-label{font-weight:600;color:#555;font-size:14px}.metric-value{font-size:20px;font-weight:bold;margin-top:8px}.blocked-badge{display:inline-block;background-color:#c62828;color:white;padding:8px 16px;border-radius:4px;font-size:14px;font-weight:600}.explanation-box{margin-top:20px;padding:16px;background-color:#fafafa;border-left:4px solid #c62828;border-radius:4px}.cta-button{display:inline-block;padding:14px 28px;background-color:#0ba09a;color:white;text-decoration:none;border-radius:6px;margin:20px 0;font-weight:600;font-size:16px}.footer{margin-top:24px;padding:16px;text-align:center;font-size:12px;color:#666}</style></head><body><div class=\"container\"><div class=\"header\"><h1 style=\"margin:0;font-size:24px\">CRITICAL: Service Blocked</h1></div><div class=\"content\"><div class=\"critical-box\"><h2 style=\"margin:0;font-size:20px\">SERVICE BLOCKED</h2><p style=\"margin:12px 0 0 0;font-size:16px;opacity:0.95\">Your project <strong>{{projectName}}</strong> has exceeded its limit</p></div><p><strong style=\"color:#c62828\">Your {{notifyFor}} data ingestion has been BLOCKED.</strong> No new data is being accepted until you upgrade your plan.</p><h3 style=\"margin-top:24px;font-size:16px\">Current Status</h3><div class=\"metric-box blocked\"><div class=\"metric-label\">Events</div><div><span class=\"blocked-badge\">BLOCKED</span></div></div><div class=\"metric-box\"><div class=\"metric-label\">Sessions</div><div class=\"metric-value\">{{sessionsPercentageDisplay}}%</div></div><p><strong style=\"color:#c62828\">Upgrade required</strong></p><ul><li>Upgrade immediately to restore data ingestion</li><li>Your observability data is not being collected</li><li>Service will resume automatically after upgrade</li></ul><div style=\"text-align:center\"><a href=\"{{dashboardUrl}}/{{tenantId}}/pricing\" class=\"cta-button\">Upgrade Now - Restore Service</a></div><div class=\"explanation-box\"><strong>What happened?</strong> You exceeded your monthly limit and overage buffer. To protect your account, data ingestion has been stopped.</div></div><div class=\"footer\"><p>This is an automated critical notification from Pulse Observability Platform</p></div></div></body></html>',
