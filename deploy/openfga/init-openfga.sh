...
# Acme Streaming tenant projects
write_tuple "tenant:acme-streaming" "parent" "project:acme-streaming-android"
write_tuple "tenant:acme-streaming" "parent" "project:acme-streaming-ios"
write_tuple "tenant:acme-streaming" "parent" "project:acme-streaming-rn"
write_tuple "tenant:acme-streaming" "parent" "project:acme-streaming-web"
write_tuple "tenant:acme-streaming" "parent" "project:acme-streaming-tv"

# Globex Fantasy tenant projects
write_tuple "tenant:globex-fantasy" "parent" "project:globex-fantasy-android"
write_tuple "tenant:globex-fantasy" "parent" "project:globex-fantasy-ios"
write_tuple "tenant:globex-fantasy" "parent" "project:globex-fantasy-web"
write_tuple "tenant:globex-fantasy" "parent" "project:globex-fantasy-pwa"
...
write_tuple "system:pulse" "system_parent" "tenant:acme-streaming"
write_tuple "system:pulse" "system_parent" "tenant:globex-fantasy"
...
write_tuple "user:admin@acme-streaming.example.com" "admin" "tenant:acme-streaming"
write_tuple "user:admin@globex-fantasy.example.com" "admin" "tenant:globex-fantasy"

# Acme Streaming sample users
write_tuple "user:developer@acme-streaming.example.com" "member" "tenant:acme-streaming"
write_tuple "user:developer@acme-streaming.example.com" "editor" "project:acme-streaming-android"
write_tuple "user:developer@acme-streaming.example.com" "editor" "project:acme-streaming-ios"
write_tuple "user:viewer@acme-streaming.example.com" "member" "tenant:acme-streaming"
write_tuple "user:viewer@acme-streaming.example.com" "member" "project:acme-streaming-web"
...
echo "    - acme-streaming (admin: admin@acme-streaming.example.com)"
echo "    - globex-fantasy (admin: admin@globex-fantasy.example.com)"
echo ""
echo "  SAMPLE USERS (acme-streaming tenant):"
echo "    - admin@acme-streaming.example.com     → Tenant Admin (full access)"
echo "    - developer@acme-streaming.example.com → Editor on Android/iOS projects"
echo "    - viewer@acme-streaming.example.com    → Viewer on Web project"
echo ""
